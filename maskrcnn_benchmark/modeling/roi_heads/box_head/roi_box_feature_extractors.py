...
from maskrcnn_benchmark.modeling.poolers import Pooler, AllLevelPooler
...
# Added by hongyang
@registry.ROI_BOX_FEATURE_EXTRACTORS.register("PA2MLPFeatureExtractor")
class PA2MLPFeatureExtractor(nn.Module):
    """
    Heads for FPN for classification
    """
